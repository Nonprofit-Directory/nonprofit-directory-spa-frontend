...
const cardBaseStyles =
  "min-w-[300px] max-w-[600px] h-full max-h-[600px] bg-[#EFECE6] rounded-xl p-6 flex flex-col justify-between gap-4 shadow-lg";
      ...
      <Card className={cardBaseStyles}>
        ...
        <CardContent className="flex-1 grid grid-cols-1 gap-y-3 text-sm overflow-auto">
          <div className="flex justify-between">
            ...
            <span className="mono">$76,297</span>
          </div>
          <div className="flex justify-between">
            <span className="font-semibold">Total expenses:</span>
            <span className="mono">$39,881</span>
          </div>
